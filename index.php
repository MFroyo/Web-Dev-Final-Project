...
<head>
	...
	<!--<title>Code4 Gaming Community</title> <!-- < set your community's name here -->
...
<body>
	...
	<header>
		<div class="wrapper">
			<nav>
				<!--<img src="./backend/img/Code4Logo.png" alt="header_logo" class = "logo">  set your community logo here make sure to hide the community name if you do change=! --> 
				<h2>Code4 <span>Gaming</span></h2> <!-- set your community name here --> 
				<div class="right">
					<div class = "dropdown">
		...
		<div class="wrapper">
			<div class="section-promo">
				<div class="promo-background">
					<h1>FivePD Roleplay Server</h1> <!-- set here title of the promo header -->
				</div>
			</div>
			<div class="section-tutorial">
				<h2>Welcome to Code4 Gaming</h2> 
				<div class="wrapper-tutorial">
					<div class="section-tutorial-container">
						...
						<div class="dsc">
							...
							<a href="https://discord.gg/code4gaming"><i class="fab fa-discord"></i>Code4 Gaming</a>
						</div>
						<div class="pab">
